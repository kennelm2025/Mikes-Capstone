...
**Version:** Week 9 pipeline | Last updated: March 2026
...
|----------|-------------|---------|-------------|-------|
| F1 | 0.15 | 0.45 | 0.85 | Extreme explore — 8 near-zero weeks |
| F2 | 0.95 | 0.008 | 0.05 | Precision lock W5 ATB [0.710,0.162] |
| F3 | 0.92 | 0.015 | 0.08 | Return to W7 ATB [1.0,0.572,0.504] |
| F4 | 0.25 | 0.18 | 0.75 | Wide explore — boundary corners |
| F5 | 0.92 | 0.025 | 0.08 | Push X1→1.0; X2-X4 locked at 1.0 |
| F6 | 0.92 | 0.018 | 0.08 | Precision lock W6 ATB [0.427,0.326,0.598,0.780,0.144] |
| F7 | 0.92 | [0.010, 0.025×5] | 0.08 | Anisotropic tighten — W8 new best confirmed |
| F8 | 0.92 | aniso | 0.08 | Anisotropic [0.008,0.015,0.008,0.030,0.020,0.015,0.008,0.030] |
...
| Fn | W8 Score | ATB | New Best? | Δ vs ATB | Key Observation |
|----|---------|-----|-----------|---------|----------------|
| F1 | 1.26e-49 | 8.84e-7 (W2) | ✗ | ≈−8.84e-7 | 8th consecutive near-zero |
| F2 | 0.4926 | 0.6497 (W5) | ✗ | −0.157 | X2 drifted to 0.043 vs ATB 0.162 |
| F3 | −0.1132 | −0.000707 (W6) | ✗ | −0.112 | X3 drifted to 0.192 vs proven 0.504 |
| F4 | −0.5542 | 0.2376 (W2) | ✗ | −0.792 | Wide exploration continuing |
| F5 | 8382.47 | 8382.47 (W8) | ★ | — | +785.68 vs W7; X1 approaching 1.0 |
| F6 | −0.4006 | −0.1727 (W6) | ✗ | −0.228 | Regression continues |
| F7 | 2.5982 | 2.5982 (W8) | ★ | — | +0.185 vs W7; anisotropic σ confirmed again |
| F8 | 9.8021 | 9.8320 (W2) | ✗ | −0.030 | Slight regression from W7=9.8251 |
...
### Week-on-Week Trajectory (W8 highlights)

F5 set a new all-time best of 8382.47 (+785.68 vs W7=7596.79). F7 set a new all-time best of 2.5982 (+0.185 vs W7=2.4134), confirming the anisotropic σ strategy for the second consecutive week. F2 and F3 both regressed due to GP drift in X2/X3 respectively — W9 returns precisely to confirmed ATB coordinates with tighter σ. F8 regressed slightly to 9.8021 (vs W7=9.8251) but remains close to the W2 ATB of 9.8320.
