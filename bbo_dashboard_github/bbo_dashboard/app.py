...
"""
import sys, os
# Ensure imports work whether Streamlit runs from repo root OR from bbo_dashboard/
...
# ── Route ──────────────────────────────────────────────────────────────────────
if "Overview" in page:
    from views.overview      import render; render(fn)
elif "Scores" in page:
    from views.scores        import render; render(fn)
elif "Strategy" in page:
    from views.strategy      import render; render(fn)
elif "Classifiers" in page:
    from views.classifiers   import render; render(fn)
elif "Pipeline" in page:
    from views.pipeline      import render; render(fn)
elif "All Functions" in page:
    from views.all_functions import render; render()
