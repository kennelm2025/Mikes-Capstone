...
**Week:** 9 of 13 | Data period: October 2025 – May 2026
...
|----------|-----------|--------------|---------|-----|-------|
| F1 | 2D | 17 | 1.26e-49 | 8.84e-7 (W2) | Flat landscape — 8 consecutive near-zero weeks |
| F2 | 2D | 17 | 0.4926 | 0.6497 (W5) | X2 drift in W8; returning to [0.710, 0.162] |
| F3 | 3D | 22 | −0.1132 | −0.000707 (W6) | X3 drift in W8; returning to W7 ATB region |
| F4 | 4D | 37 | −0.5542 | 0.2376 (W2) | Wide exploration; inject abandoned since W8 |
| F5 | 4D | 27 | 8382.47 ★ | 8382.47 (W8) | New ATB W8; X1 approaching 1.0 boundary |
| F6 | 5D | 27 | −0.4006 | −0.1727 (W6) | Continued regression; precision lock W9 |
| F7 | 6D | 37 | 2.5982 ★ | 2.5982 (W8) | Anisotropic σ delivering consecutive new bests |
| F8 | 8D | 47 | 9.8021 | 9.8320 (W2) | 0.030 from ATB; anisotropic σ W9 |

Total observations at W9: **231 query-response pairs** across 8 functions (223 at W8 + 8 W8 submissions).

**★** = new all-time best set in W8
...
Week 1 data collected approximately October 2025; collection continues through approximately May 2026 (Week 13). At W9, nine weeks of data have been collected (W1–W9, W9 pending portal return).
...
**Notable W9 change:** W8 added two new all-time bests (F5: 8382.47, F7: 2.5982). F2 and F3 experienced GP drift regressions — W9 applies precision lock recovery. F8 switches to anisotropic σ to better exploit the per-dimension structure visible in the W2 ATB point. F4 inject override remains removed. W7 confirmed the W2 coordinates at [0.439,0.415,0.385,0.398] do not reproduce the +0.2376 score. No override is applied to F4 from W8 onward.
